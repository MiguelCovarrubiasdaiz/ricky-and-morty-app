...
function TestCharacterSelection() {
  ...
  return (
    <div>
      <div data-testid="character1">
        {character1 ? character1.name : 'No character 1'}
      </div>
      <div data-testid="character2">
        {character2 ? character2.name : 'No character 2'}
      </div>
      <button onClick={() => selectCharacter1(mockCharacter1)}>
        Select Character 1
      </button>
      <button onClick={() => selectCharacter2(mockCharacter2)}>
        Select Character 2
      </button>
    ...
    function TestReplaceSelection() {
      ...
      return (
        <div>
          ...
          <button onClick={() => selectCharacter1(anotherCharacter)}>
            Select Summer
          </button>
        </div>
      )
