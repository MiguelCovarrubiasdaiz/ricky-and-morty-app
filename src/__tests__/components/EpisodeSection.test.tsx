...
const mockSortEpisodesByNumber = episodeFiltersUtils.sortEpisodesByNumber as jest.MockedFunction<
  typeof episodeFiltersUtils.sortEpisodesByNumber
>;
...
describe('EpisodeSection', () => {
  ...
  it('displays episode count for single episode', () => {
    render(<EpisodeSection title="Test Episodes" episodes={[mockEpisodes[0]]} />);
  ...
  it('renders loading state when loading is true', () => {
    const { container } = render(
      <EpisodeSection title="Test Episodes" episodes={mockEpisodes} loading={true} />
    );
  ...
  it('renders empty state when no episodes', () => {
    render(<EpisodeSection title="Test Episodes" episodes={[]} />);
  ...
  it('renders custom empty message', () => {
    render(
      <EpisodeSection title="Test Episodes" episodes={[]} emptyMessage="Custom empty message" />
    );
