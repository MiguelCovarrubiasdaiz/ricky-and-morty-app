...
describe('EpisodeCard', () => {
  ...
  it('should handle many characters correctly', () => {
    const manyCharacterEpisode: Episode = {
      ...mockEpisode,
      characters: Array.from({ length: 15 }, (_, i) => `https://rickandmortyapi.com/api/character/${i + 1}`)
    }
  ...
  it('should handle long episode names correctly', () => {
    ...
    expect(screen.getByText('This is a very long episode name that should be handled properly')).toBeInTheDocument()
  })
