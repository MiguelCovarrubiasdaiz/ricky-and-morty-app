export default function CharacterCardSkeleton() {
  return (
    <div className="animate-pulse rounded-lg border border-gray-700 bg-gray-800/50 p-4">
      <div className="flex items-center space-x-3">
        <div className="h-[60px] w-[60px] flex-shrink-0 rounded-lg bg-gray-700"></div>
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center space-x-1">
            <div className="h-3 w-3 rounded bg-gray-700"></div>
